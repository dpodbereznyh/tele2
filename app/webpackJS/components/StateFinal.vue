<template>
	<div class="main-screen__form_final">
      ...
      Скоро ты узнаешь скилл, который будешь прокачивать на конференции, а пока скачивай Telegram. Самую важную информацию ты будешь получать именно там. Команда организаторов самостоятельно добавит тебя в Telegram-канал, в котором ты получишь подробную инструкцию.
		</p>
		<!-- <p class="main-screen__form_description TextP">
